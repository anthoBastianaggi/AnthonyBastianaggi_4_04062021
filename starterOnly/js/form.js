 ...
 */
 function validate() {
	if (firstname.validity.valueMissing || lastname.validity.valueMissing || email.validity.valueMissing) {
        return false
	} else if (!isString(firstname.value) || !isString(firstname.value) || !regex.regexName.test(firstname.value) || !regex.regexName.test(lastname.value) || !isEmail(email.value)) {
        return false
